...
class CropPdf(object):
	def __init__(self, filename, filepath):
		...
		if filepath[-8:]=="death_1/":
			...
			part1 = Partition(doc_id = newdoc.id, column = 6, count = 0, flag = False, url = "death_1/%s/%s(ONE).pdf" %(filename,filename))
			...
			part2 = Partition(doc_id = newdoc.id, column = 2, count = 0, flag = False, url = "death_1/%s/%s(TWO).pdf" %(filename,filename))
			...
			part3 = Partition(doc_id = newdoc.id, column = 1, count = 0, flag = False, url = "death_1/%s/%s(THREE).pdf" %(filename,filename))
			...
			part4 = Partition(doc_id = newdoc.id, column = 1, count = 0, flag = False, url = "death_1/%s/%s(FOUR).pdf" %(filename,filename))
			...
			part5 = Partition(doc_id = newdoc.id, column = 3, count = 0, flag = False, url = "death_1/%s/%s(FIVE).pdf" %(filename,filename))
			...
			part6 = Partition(doc_id = newdoc.id, column = 2, count = 0, flag = False, url = "death_1/%s/%s(SIX).pdf" %(filename,filename))
			...
			part7 = Partition(doc_id = newdoc.id, column = 1, count = 0, flag = False, url = "death_1/%s/%s(SEVEN).pdf" %(filename,filename))
			...
			part8 = Partition(doc_id = newdoc.id, column = 5, count = 0, flag = False, url = "death_1/%s/%s(EIGHT).pdf" %(filename,filename))
